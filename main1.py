...
#
#         csvLine = getDateStr(tasmaxSplitLine[0], ',') + ",-99.9," + tasmaxSplitLine[1] + "," + tasminSplitLine[1] + '\n'
#         txtLine = getDateStr(tasmaxSplitLine[0], "\t\t") + "\t\t-99.9\t\t" + tasmaxSplitLine[1] + "\t\t" + tasminSplitLine[1] + '\n'
#
#         csvContent += csvLine
#         txtContent += txtLine
#
...
for inputFile in os.listdir("date/indices/"):
    print(inputFile)
    # splitInputFile = inputFile.split('_')
    #
    # lat = splitInputFile[0]
